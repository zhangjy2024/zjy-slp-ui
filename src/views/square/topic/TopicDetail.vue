<template>
  <div>
    <el-page-header @back="goBack" content="话题详情" style="width: calc(100% - 20px); height: 60px; background-color: white; padding-left: 20px;"></el-page-header>
    <div class="article-detail-container">
      <!-- 文章头部信息 -->
      <div class="article-header">
        <div style="display: flex;">
          <h1 class="article-title">#{{ article.title }}</h1>
          <el-button type="primary" icon="el-icon-plus" style="height: 45px; padding: 15px; margin: auto 10px 10px auto;">参与话题</el-button>
        </div>
        ...
        <div class="article-meta">
          ...
          <div class="stats">
            <span class="view-count">
              <i class="el-icon-tickets"></i> {{ article.viewCount }} 文章数
            </span>
